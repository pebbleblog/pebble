...
export CLASSPATH=$PEBBLE_HOME/WEB-INF/lib/pebble-2.0.0-M3-dev.jar:$PEBBLE_HOME/WEB-INF/lib/commons-logging.jar:$PEBBLE_HOME/WEB-INF/lib/acegi-security-1.0.0-RC2.jar:$PEBBLE_HOME/WEB-INF/lib/commons-codec-1.3.jar
