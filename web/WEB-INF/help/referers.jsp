<div class="contentItem">
  ...
  <div class="contentItemBody">
    <p>
      Pebble keeps track of your referers - those websites that have links to your blog. Typically, when a user clicks on a link to your blog from another website, the URL of that website is included in the underlying HTTP request and Pebble keeps a note of it.
    ...
    <p>
      ...
      you add regular expressions that act as filters. For example, to stop all Google searches from showing up in your referer list would require a filter of <code>.*google.*</code>.
    </p>
  </div>
</div>