...
Quickstart with Tomcat 5.5.x
----------------------------
The documentation set (not included in this milestone distribution) contains full details of how to install and configure Pebble, but if you're in a hurry, here's a summary.
